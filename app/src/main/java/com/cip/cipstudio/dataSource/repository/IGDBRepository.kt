...
interface IGDBRepository {
    ...
    suspend fun searchGames(searchText: String, pageIndex: Int = 0, pageSize: Int = 10, refresh: Boolean = false, filterCriteria: Criteria = OperatorCriteria(OperatorEnum.AND)): List<GameDetails>
